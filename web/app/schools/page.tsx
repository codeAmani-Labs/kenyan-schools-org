...
export const metadata = {
  ...
  description: 'Full index of 1,127+ Kenyan secondary schools across all 47 counties. Search, filter, and browse by county or name — with unique CodeAmani Labs Index Numbers (KSO-XXXX). Official transparent public directory by CodeAmani Labs.',
  openGraph: {
      ...
      <nav className="glass-nav sticky top-0 z-50">
        <div className="mx-auto max-w-7xl px-6 flex h-14 items-center justify-between text-sm">
          ...
          <div className="flex items-center gap-6 text-sm font-medium">
            ...
            <a 
              href="https://github.com/codeamanilabs/kenyan-schools-org" 
              target="_blank" 
